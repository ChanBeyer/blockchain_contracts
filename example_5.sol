...
contract Purchase {
  ...
  /* We build an enum State which consists of 3 possible values for
  the state of the contract. Every state variable has a default
  value of the first member ,`State.created */
  State public state;
  ...
  The amount of ether will be locked until the function
  ...
  function confirmReceived() public onlyBuyer inState(State.
  Locked)
  {
    emit ItemReceived();
